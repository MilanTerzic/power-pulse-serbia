...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SEE Trading Desk — Serbia Arbitrage & CBC Resale" },
      { name: "description", content: "Cross-border electricity arbitrage and capacity resale monitor for the Serbia trading desk." },
    ],
