    ...
    <aside className="w-56 shrink-0 bg-surface border-r border-border/60 flex flex-col">
      <div className="px-4 py-4 border-b border-border/60">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded bg-gradient-to-br from-primary to-info grid place-items-center text-primary-foreground font-bold">
            ⚡
          </div>
          <div>
      ...
      <button
        onClick={signOut}
        className="flex items-center gap-2 px-4 py-3 text-sm text-muted-foreground hover:text-foreground border-t border-border/60"
      >
